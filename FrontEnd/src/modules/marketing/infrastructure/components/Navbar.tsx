            ...
            <div className="flex items-center justify-between h-full max-w-7xl mx-auto px-6 md:px-12">
                ...
                <div className="flex items-center gap-10">
                    ...
                    <div className="hidden md:flex gap-10 text-sm font-medium font-['Montserrat']">
                        ...
                        <a href="#soluciones" className="transition-colors duration-300 text-white/70 hover:text-accent">Acerca de</a>
                        <a href="#problemas" className="transition-colors duration-300 text-white/70 hover:text-accent">Soluciones</a>
